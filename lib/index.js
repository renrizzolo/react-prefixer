...
var applyPrefixes = function applyPrefixes(object) {
  ...
  return Object.keys(object).reduce(function (styleObject, originalKey) {
    ...
    if (originalKey === 'position' && object[originalKey] === 'sticky' && !(0, _supports2.default)('position', 'sticky')) {
      return _extends({}, styleObject, _defineProperty({}, originalKey, _prefix2.default.css + 'sticky'));
    }
